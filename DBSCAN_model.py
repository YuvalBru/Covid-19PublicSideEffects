...
fig = plt.figure()
ax = fig.add_subplot(111, projection='3d')#ChatGPT plotting 3D graph
scatter = ax.scatter(
    pca_result[:, 0],
    pca_result[:, 1],
    pca_result[:, 2],
...
plt.scatter(pca_result[:, 0], pca_result[:, 1], c=dbscan_clusters, cmap='viridis', s=20) #ChatGPT plotting 2D graph
