...
#Splitting to train test validation data
x_temp, x_train, y_temp, y_train = train_test_split(x, y, test_size=0.7, random_state=42)
x_test, x_val, y_test, y_val = train_test_split(x_temp, y_temp, test_size=0.5, random_state=42)
#Defining the grid of parameters in order to perform grid search
param_grid = {
    'n_d': [8, 16, 32],
    'n_a': [8, 16, 32],
...
#best_params
#Utilizing best parameters in defining the tabnet network
